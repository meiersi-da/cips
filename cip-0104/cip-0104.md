...
- **app composition weight**: the weight of the app used when computing the app composition incentives. Default: `1.0`
...
### Introduce Extra Configuration Parameters


* change `AmuletConfig.RewardsConfig` to add
  * field `extraFeaturedAssetsActivityWeight : Decimal` with default `0.2`
  * field `maxExtraActivityWeightPerAsset : Decimal` with default `0.1`
  * field `dsoAppActivityWeight : Decimal` with default `0.5`
    * essentially configures a kind of revenue share that venues get for CC txs
